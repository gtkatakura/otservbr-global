...
local equipitems = {
	...
	["void"] = {"axe", "club", "sword", "wand", "rod", "special_strike", "bow", "crossbow", "helmet","helmetmage", "elemental_swords", "elemental_axes", "elemental_clubs", "crit_wandrod", "life_wandrod", "spellbooks", "helmet", "armor", "shield"}, -- Mana
